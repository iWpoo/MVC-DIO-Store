...
**Внимание: Данная инструкцию по установке и запуска проекта подразумевает что у вас уже установлен PHP, Composer, MySQL или другая реляционная база данных и Redis!**
