...
**Внимание: Данная инструкция по установке и запуска проекта подразумевает что на вашем локальном компьютере уже установлен PHP, Composer, MySQL или другая реляционная база данных и Redis!**
